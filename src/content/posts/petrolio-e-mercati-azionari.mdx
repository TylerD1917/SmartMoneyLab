...
<div style="margin: 1.5rem 0; padding: 1.25rem 1.5rem; border: 2px solid #d97706; border-radius: 1rem; background: #fef3c7;">
  <div style="font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em; color: #92400e; font-weight: 600;">Strumento correlato</div>
  <div style="font-size: 1.1rem; font-weight: 700; color: #451a03; margin-top: 0.25rem;">
    Simulatore Regime Petrolio
  </div>
  <div style="color: #78350f; margin-top: 0.5rem; font-size: 0.95rem;">
  ...
  <div style="margin-top: 0.75rem;">
    <a href="/strumenti/simulatore-regime-petrolio" style="display: inline-block; background: #d97706; color: white; padding: 0.5rem 1rem; border-radius: 0.5rem; text-decoration: none; font-weight: 600;">
      Apri il simulatore →
    </a>
  </div>
</div>
