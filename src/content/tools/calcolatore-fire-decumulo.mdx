...
<div style="margin: 1.5rem 0; padding: 1rem 1.25rem; background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 0.75rem;">
  <strong>Il ragionamento dietro i numeri.</strong> Simulazione Monte Carlo e fiscalità italiana nello studio completo: <a href="/posts/quanto-capitale-serve-per-smettere-di-lavorare"><b>Quanto capitale serve per smettere di lavorare in Italia?</b></a>
</div>
