...
<div style="margin: 1.5rem 0; padding: 1rem 1.25rem; background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 0.75rem;">
  <strong>Il ragionamento dietro i numeri.</strong> Metodologia, regressioni e grafici completi nello studio: <a href="/posts/shiller-cape-predice-rendimenti"><b>Il CAPE di Shiller predice i rendimenti futuri del mercato?</b></a>
</div>
